        ...
        <div className="grid md:grid-cols-3 gap-8 mb-8">
          ...
          <div>
            ...
            <ul className="space-y-2 text-gray-300">
              <li>
                <a href="mailto:info@festivallallera.cat" className="hover:text-white transition-colors">
                  info@festivallallera.cat
                </a>
              </li>
              <li>Tel: +34 972 XXX XXX</li>
              <li>Celrà, Girona</li>
              <li>
                <a href="/contacte" className="hover:text-white transition-colors">
                  ↗ Més informació
                </a>
              </li>
            </ul>
          ...
          {/* Enllaços */}
          <div>
            <h3 className="text-lg font-semibold mb-4">Enllaços</h3>
            <ul className="space-y-2 text-gray-300">
              <li>
                <button 
                  onClick={() => document.getElementById('bases')?.scrollIntoView({ behavior: 'smooth' })}
          ...
          <div>
            ...
            <div className="flex space-x-4">
              ...
              <a 
                href="#" 
                className="bg-gray-800 hover:bg-black w-10 h-10 rounded-full flex items-center justify-center transition-colors"
                aria-label="TikTok"
              >
                <svg
                  xmlns="http://www.w3.org/2000/svg"
              ...
              <a 
                href="#" 
                className="bg-gray-800 hover:bg-sky-500 w-10 h-10 rounded-full flex items-center justify-center transition-colors"
                aria-label="Vimeo"
              >
                <svg
                  xmlns="http://www.w3.org/2000/svg"
